...
export const SCRAPER_WEBSITES: WebsiteConfig[] = [
  { name: 'Ministry of Road Transport and Highways (MoRTH)', url: 'https://morth.nic.in', type: 'government' },
  { name: 'National Highways Authority of India (NHAI)', url: 'https://nhai.gov.in', type: 'government' },
  ...
  { name: 'Ministry of Housing and Urban Affairs', url: 'https://mohua.gov.in', type: 'government' },
  ...
  { name: 'Ministry of Civil Aviation', url: 'https://www.civilaviation.gov.in', type: 'government' },
  { name: 'NTPC', url: 'https://ntpc.co.in', type: 'company' },
  { name: 'NHPC (Hydropower)', url: 'https://nhpcindia.com', type: 'company' },
  { name: 'Power Grid Corporation of India (PGCIL)', url: 'https://www.powergrid.in', type: 'company' },
  ...
  { name: 'Karnataka Infrastructure', url: 'https://infrastructure.karnataka.gov.in', type: 'government' },
  ...
  { name: 'Uttar Pradesh Expressways (UPEIDA)', url: 'https://upeida.up.gov.in', type: 'government' },
  { name: 'Bihar Infrastructure', url: 'https://state.bihar.gov.in/roadconstruction', type: 'government' },
  ...
  { name: 'Adani Infra', url: 'https://www.adanienterprises.com/businesses/AdaniInfrastructure', type: 'company' },
  ...
  { name: 'Business Standard Infra', url: 'https://www.business-standard.com/category/economy-policy/infrastructure', type: 'news' },
  { name: 'Financial Express Infra', url: 'https://www.financialexpress.com/industry/infrastructure/', type: 'news' },
  { name: 'Moneycontrol Infra', url: 'https://www.moneycontrol.com/news/business/infrastructure', type: 'news' },
  { name: 'Livemint Infra', url: 'https://www.livemint.com/industry/infrastructure', type: 'news' },
  { name: 'InfraCircle', url: 'https://infra.economictimes.indiatimes.com/tag/InfraCircle', type: 'news' },
  { name: 'The Hindu Infra', url: 'https://www.thehindu.com/business/infrastructure/', type: 'news' },
  { name: 'Hindustan Times Infra', url: 'https://www.hindustantimes.com/business/infrastructure', type: 'news' },
  { name: 'Business Today Infra', url: 'https://www.businesstoday.in/latest/infrastructure', type: 'news' },
  ...
  { name: 'PPP in India - State Projects', url: 'https://www.pppinindia.gov.in/infrastructure_projects_statewise', type: 'government' },
  { name: 'ET Infrastructure - DPIIT Review', url: 'https://infra.economictimes.indiatimes.com/news/urban-infrastructure/dpiit-reviews-374-high-impact-infra-projects-worth-rs-17-lakh-cr-in-fy22/90550399', type: 'news' },
  { name: 'Economic Times - NIP', url: 'https://economictimes.indiatimes.com/news/economy/infrastructure/national-infrastructure-pipeline-outlay-stands-at-rs-109-lakh-crore/articleshow/106190598.cms', type: 'news' },
  { name: 'Business Standard - L&T Orders', url: 'https://www.business-standard.com/markets/capital-market-news/larsen-toubro-wins-multiple-orders-under-its-ce-ipdd-vertical-125091900477_1.html', type: 'news' },
  { name: 'IRCON', url: 'https://www.ircon.org/index.php?lang=en', type: 'company' },
  { name: 'Live Hindustan - Sanatan Project', url: 'https://www.livehindustan.com/uttarakhand/world-largest-sanatan-sansad-1000-crore-budget-weapon-training-centre-108-cottages-for-saintscompleted-till-2032-201760608648283.html', type: 'news' },
  { name: 'IBEF - Infrastructure Sector', url: 'https://ibef.org/industry/infrastructure-sector-india', type: 'other' },
  { name: 'New Projects Tracker', url: 'https://www.newprojectstracker.com', type: 'other' },
  { name: 'Projects Today Portal', url: 'https://www.projectstoday.com/Default.aspx', type: 'news' },
  { name: 'PIB - Press Information Bureau', url: 'https://www.pib.gov.in/indexd.aspx', type: 'government' },
  ...
  { name: 'India Investment Grid Portal', url: 'https://indiainvestmentgrid.gov.in/index.jsp', type: 'government' },
  ...
  { name: 'Infrastructure Today Magazine', url: 'https://infrastructuretoday.co.in/', type: 'news' },
  { name: 'India Infrastructure Magazine', url: 'https://indiainfrastructure.com/magazines/', type: 'news' },
  { name: 'Projects Monitor', url: 'https://www.projectsmonitor.com/', type: 'other' },
  { name: 'IIG - NIP Projects', url: 'https://indiainvestmentgrid.gov.in/opportunities/nip-projects', type: 'government' },
  { name: 'India Investment Grid', url: 'https://indiainvestmentgrid.gov.in/', type: 'government' },
  { name: 'Tata Projects - Press Releases', url: 'https://tataprojects.com/news-media/press-releases', type: 'company' },
...
export const getWebsitesByType = (type: 'government' | 'company' | 'news' | 'other'): WebsiteConfig[] => {
