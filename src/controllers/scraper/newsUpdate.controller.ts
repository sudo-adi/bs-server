...
import {
  NewsUpdateFilters,
  PaginationParams,
} from '@/services/utilities/newsUpdate/queries/news-update.query';
...
export const getAllNewsUpdates = catchAsync(async (req: Request, res: Response) => {
  ...
  const filters: NewsUpdateFilters = {
    ...
    minValue: min_value ? parseFloat(min_value as string) : undefined,
    maxValue: max_value ? parseFloat(max_value as string) : undefined,
...
export const getNewsStats = catchAsync(async (req: Request, res: Response) => {
