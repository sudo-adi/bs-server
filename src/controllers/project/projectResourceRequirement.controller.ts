import { projectResourceRequirementService } from '@/services/project';
...
export const getAllRequirements = catchAsync(async (req: Request, res: Response) => {
  const { projectId, skillCategoryId, limit, offset } = req.query;

  const filters = {
    projectId: projectId as string | undefined,
    skillCategoryId: skillCategoryId as string | undefined,
