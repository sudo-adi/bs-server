...
import socialMediaPostService from './socialMediaPost/socialMediaPost.service';

export { newsScraperService, newsUpdateService, scraperWebsiteService, socialMediaPostService };
